  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-xl p-6">
      <div className="w-full max-w-md bg-[#16161c] border border-white/5 rounded-3xl p-8 shadow-2xl relative overflow-hidden group">
        ...
        <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#e6c487]/10 blur-[100px] rounded-full group-hover:bg-[#e6c487]/20 transition-all duration-1000" />
        ...
        <div className="flex flex-col items-center text-center space-y-6 relative z-10">
          ...
          <div className="space-y-2">
            <h2 className="font-serif italic text-2xl text-[#e6c487]">
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-4">
            <div className="relative">
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-center text-2xl tracking-[0.5em] text-[#e4e1ed] focus:outline-none focus:border-[#e6c487]/50 focus:bg-white/[0.08] transition-all placeholder:text-[10px] placeholder:tracking-widest placeholder:uppercase placeholder:text-[#998f81]/40"
                maxLength={12}
                disabled={loading}
              />
              {error && (
            ...
            <button
              ...
              className="w-full bg-[#e6c487] text-[#0d0d15] font-bold py-4 rounded-2xl shadow-[0_0_20px_rgba(230,196,135,0.2)] hover:shadow-[0_0_30px_rgba(230,196,135,0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:grayscale disabled:hover:scale-100 flex items-center justify-center gap-2"
            >
              {loading ? (
          ...
          <button
            onClick={() => signOut()}
            className="text-[10px] uppercase tracking-widest text-[#998f81]/40 hover:text-[#e6c487] transition-colors"
          >
