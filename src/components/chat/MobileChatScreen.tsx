...
export default function MobileChatScreen({ partner, isActive, partnerIsTyping, sendTypingEvent, snapCapture }: MobileChatScreenProps) {
          ...
          <div className="flex items-center gap-4 text-aura-text-secondary">
            ...
            <div className="relative" ref={callDropdownRef}>
              <button 
                ...
                className="hover:text-primary transition-colors active:scale-90 flex items-center justify-center p-1 text-aura-text-secondary"
                title="Call Options"
              >
              ...
              >
                ...
                <div className="flex justify-between items-start gap-4 z-10">
                  <div className="flex items-center gap-2">
                    ...
                    <h4 className="text-xs font-bold text-white uppercase tracking-wider">New: Instant Video Streaming! 🎥</h4>
                  </div>
                  <button
                    onClick={() => {
                ...
                <p className="text-[11px] text-white/60 leading-relaxed font-medium z-10">
                  YouTube-style progressive playback is now active! Received chunked videos will start playing instantly as soon as the first few blocks arrive.
                </p>
                <div className="flex items-center gap-3 mt-1 z-10">
                  <button
                    onClick={() => {
